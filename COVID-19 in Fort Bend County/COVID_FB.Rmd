...
memorial_day=weekly_long_df[8,]$Week
ggplot(data=weekly_long_df[as.Date(weekly_long_df$Week) != as.Date('2020-06-16'),], aes(x=Week, y=Total, group=Category)) + 
  ...
  geom_vline(aes(xintercept=memorial_day), linetype="dotted", color="red", size=1) +
